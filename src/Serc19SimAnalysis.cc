...
void Serc19SimAnalysis::OpenRootfiles(G4String outfile) {
  ...
  h_hcal_total_energy = new TH1F("hcal_total_energy", "HCAL Total Energy (GeV)", 200, 0, 400);
  h_ecal_hcal_total_energy = new TH1F("ecal_hcal_total_energy", "ECAL+HCAL Total Energy (GeV)", 200, 0, 400);
