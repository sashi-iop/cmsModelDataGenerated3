...
## VISUALISATION
   ...
   in the main () function in exampleB6.cc.
...
## HOW TO RUN
   ...
   - Execute exampleB6 in the 'interactive mode' with visualization
```
% exampleB6
...
```
   ...
   - Execute exampleB6 in the 'batch' mode from macro files
   (without visualization)
```
% exampleB6 run2.mac
% exampleB6 exampleB6.in > exampleB6.out
```
